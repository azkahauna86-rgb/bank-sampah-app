...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    final err = await auth.login(_emailC.text.trim(), _passC.text.trim());
    if (err != null && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: [
            // Dekorasi bulatan blur ala glassmorphism
            Positioned(
              top: -60,
              right: -40,
              child: _blobCircle(180, Colors.white.withOpacity(0.08)),
            ),
            Positioned(
              bottom: -80,
              left: -60,
              child: _blobCircle(220, Colors.white.withOpacity(0.06)),
            ),
            SafeArea(
              child: Center(
